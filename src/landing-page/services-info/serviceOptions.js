const options = [
  {
    ...
    description: "One-to-one sessions are individualized, evidence-based therapeutic services for ages 18 and up. Services include assessment, goal setting  and treatment planning.",
    link: null
  },
  {
